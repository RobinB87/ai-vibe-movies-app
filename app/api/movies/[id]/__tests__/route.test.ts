...
describe("Movie by ID API", () => {
  ...
  describe("GET /api/movies/[id]", () => {
    it("should return a movie where user has a preference", async () => {
      ...
      (prisma.movie.findFirst as jest.Mock).mockResolvedValue(mockMovieFromDb);
    ...
    it("should return 404 if movie not found or user has no preference", async () => {
